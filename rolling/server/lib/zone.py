...
class ZoneLib:
    ...
    def destroy_tile(
        ...
        tile_type: typing.Type[MapTileType] = zone_map.source.geography.rows[zone_row_i][zone_col_i]
        tiles_properties = self._kernel.game.world_manager.world.tiles_properties[tile_type]
        assert tiles_properties.replace_by_when_destroy is not None
        ...
        line_as_char_list[zone_col_i] = zone_map.source.geography.legend.get_str_with_type(
            tiles_properties.replace_by_when_destroy
        )
