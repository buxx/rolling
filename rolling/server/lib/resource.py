...
class ResourceLib:
    ...
    def add_resource_to(
        ...
        if exclude_shared_with_affinity:
            assert not shared_with_affinity_id
    ...
    def get_carried_by(
        self, character_id: str, exclude_shared_with_affinity: bool = False
    ) -> typing.List[CarriedResourceDescriptionModel]:
        resource_docs: typing.List[ResourceDocument] = self.get_base_query(
            carried_by_id=character_id, exclude_shared_with_affinity=exclude_shared_with_affinity
        ).all()
    ...
    def get_one_carried_by(
        self, character_id: str, resource_id: str, shared_with_affinity_id: typing.Optional[int] = None, exclude_shared_with_affinity: bool = False
    ) -> CarriedResourceDescriptionModel:
