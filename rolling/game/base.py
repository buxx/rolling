...
class GameConfig:
    def __init__(self, config_dict: dict) -> None:
        ...
        self._resource_mixs: typing.List[
            ResourceMixDescription
    ...
    @property
    def resource_mixs(self) -> typing.List[ResourceMixDescription]:
    ...
    def _create_resource_mixs(
        ...
        for mix_raw in config_dict.get("resource_mix", {}).values():
    ...
    def get_resource_mixs_with(
        ...
        for resource_mix_description in self.resource_mixs:
            all_in = True
