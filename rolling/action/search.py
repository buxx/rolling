...
class SearchMaterialAction(CharacterAction):
    ...
    def check_request_is_possible(self, character: "CharacterModel", input_: SearchMaterialModel) -> None:
    ...
    def get_character_actions(self, character: "CharacterModel") -> typing.List[
        CharacterActionLink]:
        return [
            CharacterActionLink(
    ...
    def perform(self, character: "CharacterModel", input_: SearchMaterialModel) -> Description:
        ...
        for produce in self._description.properties["produce"]:
            ...
            quantity_found = quantity_found - (quantity_found * random.randint(0, random_loss) / 100)
            ...
            # Test if zone contain resource in some tile
                ...
                resource_id,
                check_from_absolute=False,
                check_from_tiles=True,
            ):
                zone_geography = zone_state.zone_map.source.geography
                extract_from_row_i, extract_from_col_i = \
        ...
        for resource_id, quantity in found:
            ...
            parts.append(Part(
                text=f"{quantity_str} de {resource_description.name}",
            ))
