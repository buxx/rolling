...
# NOTE: test are based on TILE_CLUTTER
class TestWorldManager:
    ...
    def test_find_available_place_where_drop_when_place_resource_on_full_free_space(  # place occupied, rocks, stuff
        self,
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                "WOOD",
                0.05,
                [((69, 40), 0.002), ((69, 41), 0.02), ((68, 42), 0.02), ((69, 41), 0.008)],
            ),
        ],
    )
