...
curl https://not-fl3.github.io/miniquad-samples/mq_js_bundle.js > static/mq_js_bundle.js

# curl https://raw.githubusercontent.com/not-fl3/miniquad/4cf7e89c3d4d43d79ecdb6ac5c8043ee3810a1f6/js/gl.js >> static/mq_js_bundle.js
...
sed -i 's/if(this.status==200){var a=new Uint8Array(this.response);ongoing_requests/if(this.status){var a=new Uint8Array(this.response);ongoing_requests/' static/mq_js_bundle.js