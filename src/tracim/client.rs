...
use super::{
    ...
    types::{
        ...
        SpaceAccessType, SpaceId, SpaceName, Username,
    },
};
...
impl Client {
    ...
    fn authenticated_by_api_key_with_admin(
        &self,
        method: Method,
        url: String,
    ...
    fn authenticated_by_api_key_with(
        &self,
        method: Method,
        url: String,
        username: Username,
    ...
    pub fn create_user(self, account: &Account) -> Result<CreatedUser, Error> {
        ...
        Ok(self
            .authenticated_by_api_key_with_admin(Method::POST, url)?
            .json(&data)
            .send()?
            .error_for_status()?
            .json::<CreatedUser>()?)
    ...
    pub fn update_user_password(
        ...
        self.authenticated_by_api_key_with_admin(Method::PUT, url)?
            .json(&data)
            .send()?
            .error_for_status()?;
        Ok(())
    ...
    pub fn remove_space_member(
        ...
        self.authenticated_by_api_key_with_admin(Method::DELETE, url)?
            .send()?
            .error_for_status()?;
        Ok(())
    }
    ...
    pub fn create_space_member(
        ...
        self.authenticated_by_api_key_with_admin(Method::POST, url)?
            .json(&data)
            .send()?
            .error_for_status()?;
        Ok(())
    ...
    pub fn get_message_summary(
        ...
        dbg!(&url);
        let value = self
            .authenticated_by_api_key_with(Method::GET, url, account.username.clone())?
            .send()?
            .error_for_status()?
            .json()?;
