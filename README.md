...
Following documentation assume you use debian 10 or similar OS. You will need:
    ...
    apt-get install git python3 python3-venv build-essential python3-dev postgresql postgresql-server-dev-11
...
* Bases
  ...
  * ☐ Participation à plusieurs de la rédaction de l'histoire (récits)/RP
  ...
  * ☐ Objets permettant de contenir et conserver la nourriture
  ...
  * ☐ Toitures (confort, moins de dégradations)
...
* Actions
  ...
  * ☐ Voler un autre personnage (et tenter d'échaper à défense de groupe)
  ...
  * ☐ Cultures
  * ☐ Proposer des actions groupés sur les objets (transformation en viande, peau, etc)
  * ☐ Généraliser l'usage de craft par progression d'ap mais pouvoir simplifier/en faire plusieurs d'affilé en une dépense
  * ☐ Ne pas permettre d'avoir deux personnages sur la même case

* Gameplay
  * ☐ Affiner les caractéristiques du perso et leur usage dans le jeu
  ...
  * ☐ Worldmap non visible là ou pas visité (et pas été visible, vue bloqué par montagne, etc)
  ...
  * ☐ Météo et influence sur les actions (hiver = peu de nourriture !, dégradations)
  ...
  * ☐ Attaque: pouvoir voir l'état des troupes (fatigue, santé, etc ennemie + sienne))
  * ☐ Amélioration des combats
  * ☐ Les liquides que dans les contenants
...
* Univers
  ...
  * ☐ Présentation du serveur (affiché à la création du personnage)
...
* Ergonomie de l'interface
  ...
  * ☐ Jonction de tuiles
  * ☐ Alignement des murs
  * ☐ Animations (bât en fonctionnement, mer, etc)
...
# ROLLING
0 * * * * cd /home/rolling/servers/heritage && venv3.7/bin/rolling-server-turn --sentry "https://x@x.ingest.sentry.io/x" worldmap.txt ./zones ./game server.ini &>> turn.logs

# ROLLING CREATIF
* * * * * cd /home/rolling/servers/creatif && venv3.7/bin/rolling-server-turn --disable-natural-needs --sentry "https://x@x.ingest.sentry.io/x" worldmap.txt ./zones ./game server.ini &>> turn.logs 
* * * * * sleep 30; cd /home/rolling/servers/creatif && venv3.7/bin/rolling-server-turn --disable-natural-needs --sentry "https://x@x.ingest.sentry.io/x" worldmap.txt ./zones ./game server.ini &>> turn.logs
